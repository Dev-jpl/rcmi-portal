...
<template>
    <div class="min-h-screen flex bg-gray-50">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed lg:static inset-y-0 left-0 z-40 w-[272px] transform transition-transform duration-300 ease-out lg:translate-x-0 flex flex-col bg-navy text-white"
        ...
        >
            ...
            <div class="px-3 py-4">
                <router-link
                    ...
                    class="flex items-center gap-3 px-3 py-3 rounded-2xl hover:bg-white/[0.06] transition-colors"
                >
                ...
                <button
                    @click="handleLogout"
                    class="flex items-center gap-2.5 w-full mt-1 px-4 py-2.5 rounded-2xl text-sm text-white/40 hover:text-red-400 hover:bg-white/[0.04] transition-colors"
                >
